...
\chapter{State of the art}
		...
		In order to build the tracker, the first step was to chose the
		...
		that could have been selected throughout the project.
		...
		One can name the following robots : \textit{Jetbot}, \textit{Kaya}.
